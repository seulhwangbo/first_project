...
<body>
	<header>
		<nav>
			...
			<div class="logo">
			<form method="post">
				<a href="../userMain"><img src="/upload/logo.png" width="150" height="70" alt="Logo"></a>
			</form>
						...
						<ul class="dropdown-menu">
							...
							<li><a class="dropdown-item" href="/tr/changeOwnEmp">회원정보수정</a>
								<a class="dropdown-item" href="/logout" onclick="logout()">로그아웃</a>
									...
									<a class="dropdown-item" href="../admin_main">관리자</a></c:if>
							</li>
						</ul>
					</div>
			    ...
			    <ul class="topMenu">
			        ...
			        <li class="icon" id="icon">
			            <ul class="menuLink">
			                ...
			                <li><a href="/tr/mail?empno=${emp.empno}"><img src="/upload/mail.png" alt="Mail"></a></li>
			            </ul>
			        </li>
			    </ul>
			</div>
