...
<body>
	<main>
		...
		<form action="listSearch5" style="text-align: center;">
			<!-- 검색 기준 선택 드롭다운 -->
			<h2
				style="margin-top: 50px; margin-bottom: 1px; padding-right: 800px;">자유게시판</h2>
...
<c:set var="num" value="${page.total - page.start + 1}" />
		...
		<table border="1">
		    <tr>
		        ...
		        <th style="color: blue; font-size: 18px;">작성자</th>
		        <th style="color: blue; font-size: 18px;">조회수</th>
		            ...
		            <td style="text-align: left;">
		                ...
		                <c:choose>
		                    <c:when test="${posts.reLevel eq 0}">
		                        <a href="/jh/detailPostsfree/${posts.postId}">${posts.postsTitle}</a>
		                    </c:when>
		                    <c:when test="${posts.reLevel != 0}">
		...
		<div class="pagination">
			...
			<input type="button" value="글작성" onclick="location.href='writeFree';">
		</div>
	</main>
</body>
</html>