...
<body>
    ...
    <div class="button-container">
        <c:if test="${emp.admin == 150 || emp.admin == 170}">
            <input type="button" value="수정" onclick="location.href='/jh/updatePosts?postId=${posts.postId}'">
            <input type="button" value="삭제" onclick="if(confirm('정말로 삭제하시겠습니까?')) { location.href='/jh/deletePosts?postsId=${posts.postId}'; showDeleteAlert(); }">
        </c:if>
